...
const users = [];
users.push(new User('Guus Lieben', 'Arjan-straat 420', '1234 AB', '23/07/2000', '+31 6 2047 3802', 'guus@xendox.com', 'hahahaNee123'));
users.push(new User('Bob Bobberson', 'Bob-Willem Straat 12', '6969 OI', '01/02/0304', '+12 3456 7890', 'bob@bob.com', 'wieIsBobEigenlijk_'));
...
function Movie(title, descr, release, director) {
    this.title = title;
...
function User(name, street, postcode, birthdate, phone, email, password) {
    this.name = name;
    this.street = street;
